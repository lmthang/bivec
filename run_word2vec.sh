...
execute_check "" "time $SCRIPT_DIR/word2vec -train $trainFile -output $outputDir/model -cbow 0 -size $dim -window 5 $negStr -sample 1e-5 -threads $numThreads -binary 0 -iter $numIter $otherOpts"
