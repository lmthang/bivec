...
public class ApLearn {
  ...
  private static void printUsageExit() {
    System.err.println("Usage: java ApLearn --train-set [file name] --model-name [file name] --epoch-num [num] ");
  }
  /**
   * @param args
   */
  public static void main(String[] args) throws  IOException {
    ...
    if(DEBUG) { System.out.println("Params: " + paramMap); }
    ...
    //System.err.print("  train " + fileName + "\t");
    ...
    if (paramMap.containsKey("--std-perceptron") && Boolean.parseBoolean(paramMap.get("--std-perceptron"))) {
      ...
      mod.save(modelName);
      if (DEBUG) { System.err.println("  save model to file " + modelName); }
    }
