...
time ./word2vec -src-train data/data.10k.de -tgt-train data/data.10k.en -align data/data.10k.align -src-lang de -tgt-lang en -output output/out -cbow 0 -size 40 -window 5 -negative 5 -hs 0 -sample 1e-5 -threads 1 -binary 0 -iter 10 -biTrain 0
